...
/// generates the placeholder sprite, the Killer / Target / Corpse / Blood prefabs
/// and the KillerPrototype scene. Run via: Tools > Game Jam > Setup Killer Prototype Scene.
...
public static class KillerPrototypeSetup
{
    ...
    public static void Setup()
    {
        ...
        BuildScene(killer, target, square);
    ...
    private static void BuildScene(GameObject killerPrefab, GameObject targetPrefab, Sprite square)
    {
